...
CREATE TABLE modules (
    id              VARCHAR(50) PRIMARY KEY,  -- e.g. 'logica', 'redes'
    title           VARCHAR(255) NOT NULL,     -- e.g. 'Lógica de Programação'
    icon            VARCHAR(100) NOT NULL,     -- Ionicons icon name
...
CREATE TABLE lessons (
    id              VARCHAR(50) PRIMARY KEY,  -- e.g. 'logica_1', 'logica_2'
    module_id       VARCHAR(50) NOT NULL REFERENCES modules(id) ON DELETE CASCADE,
    title           VARCHAR(255) NOT NULL,
    icon            VARCHAR(100) NOT NULL,     -- Ionicons icon name
    description     TEXT,
    lesson_order    INT NOT NULL,              -- 1 to 9
    is_exercise     BOOLEAN NOT NULL DEFAULT FALSE, -- TRUE for lesson 9
...
-- ============================================================
-- LESSON STEPS (content within each lesson)
-- ============================================================
...
-- ============================================================
-- EMBEDDED QUESTIONS (inside lesson steps of type 'question')
-- ============================================================
...
-- ============================================================
-- MOCK QUESTIONS (used by ExerciseScreen / lesson 9)
-- ============================================================
...
-- ============================================================
-- ASSESSMENT QUESTIONS (used by QuizScreen)
-- ============================================================
CREATE TABLE assessment_questions (
    id              SERIAL PRIMARY KEY,
    module_id       VARCHAR(50) NOT NULL REFERENCES modules(id) ON DELETE CASCADE,
    topic           VARCHAR(255),             -- sub-topic within module
    question        TEXT NOT NULL,
    options         JSONB NOT NULL,
...
CREATE TABLE user_progress (
    ...
    module_id           VARCHAR(50) NOT NULL REFERENCES modules(id) ON DELETE CASCADE,
    completed_lessons   JSONB NOT NULL DEFAULT '[]',  -- ['logica_1', 'logica_2', ...]
    quiz_score          INT,                          -- number of correct answers
    quiz_total          INT,                          -- total questions
    quiz_percentage     INT,                          -- rounded percentage
